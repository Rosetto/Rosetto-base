...
public class BaseFunctionsTest {
    ...
    public void useTest() throws Exception {
        ...
        Contexts.importPackage(p, "foo");
        assertThat(Contexts.getAction("testfunc"), is((RosettoAction)Values.NULL));
        assertThat(Contexts.getAction("foo.testfunc"), is((RosettoAction)f1));
        RosettoValue sut1 = BaseFunctions.use.execute("foo", testScope);
        assertThat(sut1, is((RosettoValue)Values.VOID));
        assertThat(Contexts.getAction("testfunc"), is((RosettoAction)f1));
        assertThat(Contexts.getAction("foo.testfunc"), is((RosettoAction)f1));
    }
    ...
    public void defnTest() {
        ...
        assertThat(Contexts.getAction("foo").execute(testScope), is((RosettoValue)Values.NULL));
    }
